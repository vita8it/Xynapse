...
function Library:Window(Args)
    ...
    Tabs_1.Name = "Tabs"
    Tabs_1.Parent = Right_1
    Tabs_1.Size = UDim2.new(0, 215, 0, 35)
    ...
    local function NewGroup()
        local Grouper_1 = Instance.new("Frame")
        local UIListLayout_1 = Instance.new("UIListLayout")
        local UIPadding_1 = Instance.new("UIPadding")

        Grouper_1.BackgroundTransparency = 1
        Grouper_1.Name = "Grouper"
        Grouper_1.Parent = Tabs_1
        Grouper_1.Size = UDim2.new(1, 0, 1, 0)
        Grouper_1.Selectable = false

        UIListLayout_1.Padding = UDim.new(0, 6)
        UIListLayout_1.Parent = Grouper_1
        UIListLayout_1.FillDirection = Enum.FillDirection.Horizontal
        UIListLayout_1.SortOrder = Enum.SortOrder.LayoutOrder
        UIListLayout_1.HorizontalAlignment = Enum.HorizontalAlignment.Right
        UIListLayout_1.VerticalAlignment = Enum.VerticalAlignment.Center

        UIPadding_1.Parent = Grouper_1
    ...
    function Window:NewPage(Icon)
        if not CurrentGroup or CurrentTabCount >= 6 then
        ...
        local Tab = {} do
            ...
            local function OnSelect()
                ...
                for _, Group in Tabs_1:GetChildren() do
                    if Group.Name == "Grouper" then
                        for _, Tab in Group:GetChildren() do
                            if Tab.Name == "NewTab" then
                                Library:Tween({
                                    v = Tab,
                                    t = 0.5,
                                    s = "Exponential",
